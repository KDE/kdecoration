...
class KDECORATIONS2_EXPORT DecorationShadow : public QObject
{
    ...
    Q_PROPERTY(double paddingTop READ paddingTop NOTIFY paddingChanged)
    Q_PROPERTY(double paddingRight READ paddingRight NOTIFY paddingChanged)
    Q_PROPERTY(double paddingBottom READ paddingBottom NOTIFY paddingChanged)
    Q_PROPERTY(double paddingLeft READ paddingLeft NOTIFY paddingChanged)
