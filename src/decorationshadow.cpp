...
double DecorationShadow::paddingTop() const
{
    return d->padding.top();
}

double DecorationShadow::paddingBottom() const
{
    return d->padding.bottom();
}

double DecorationShadow::paddingRight() const
{
    return d->padding.right();
}

double DecorationShadow::paddingLeft() const
{
