...
class KDECORATIONS2_EXPORT Decoration : public QObject
{
    ...
    Q_PROPERTY(double borderLeft READ borderLeft NOTIFY bordersChanged)
    Q_PROPERTY(double borderRight READ borderRight NOTIFY bordersChanged)
    Q_PROPERTY(double borderTop READ borderTop NOTIFY bordersChanged)
    Q_PROPERTY(double borderBottom READ borderBottom NOTIFY bordersChanged)
    Q_PROPERTY(QMarginsF resizeOnlyBorders READ resizeOnlyBorders NOTIFY resizeOnlyBordersChanged)
    Q_PROPERTY(double resizeOnlyBorderLeft READ resizeOnlyBorderLeft NOTIFY resizeOnlyBordersChanged)
    Q_PROPERTY(double resizeOnlyBorderRight READ resizeOnlyBorderRight NOTIFY resizeOnlyBordersChanged)
    Q_PROPERTY(double resizeOnlyBorderTop READ resizeOnlyBorderTop NOTIFY resizeOnlyBordersChanged)
    Q_PROPERTY(double resizeOnlyBorderBottom READ resizeOnlyBorderBottom NOTIFY resizeOnlyBordersChanged)
    /**
...
public:
    ...
    double resizeOnlyBorderLeft() const;
    double resizeOnlyBorderRight() const;
    double resizeOnlyBorderTop() const;
    double resizeOnlyBorderBottom() const;
